...
% Réf: https://iclr.cc/Conferences/2023/CallForPapers
...
\author{Prénom NOM 1 \\
\\
\texttt{prénom.nom1@utc.etu.fr}
\And
Prénom NOM 2
\\
\texttt{prénom.nom2@utc.etu.fr}
\And
Prénom NOM 3\\
\texttt{prénom.nom3@utc.etu.fr}
}
...
\begin{abstract}
Vous devez écrire un résumé du projet étudié. Le résumé doit être composé d'un seul paragraphe. 
...
\newpage
\bibliography{bibliographie_projet}
